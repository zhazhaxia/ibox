(window.webpackJsonp = window.webpackJsonp || []).push([[13, 2, 3], {
  ...
  219 : function(t, e, s) {
      ...
      var A = function(t, e, s, a) {
          ...
          o = n < 3 ? e: null === a ? a = Object.getOwnPropertyDescriptor(e, s) : a;
          if ("object" === ("undefined" == typeof Reflect ? "undefined": $()(Reflect)) && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, s, a);
          else for (var r = t.length - 1; r >= 0; r--)(i = t[r]) && (o = (n < 3 ? i(o) : n > 3 ? i(e, s, o) : i(e, s)) || o);
  ...
  default);
      ...
      W = (s(232), s(233), Object(o.a)(K, (function() {
          var t = this,
          e = t.$createElement,
          s = t._self._c || e;
          return s("header", {
      ...
      var tt = {
          ...
          computed: {...Object(a.e)(["isMobile", "inSearch", "isApp"]),
              scrollDirection() {
                  if (this.showMenu || this.inSearch) return J;
      ...
      et = (s(235), Object(o.a)(tt, (function() {
          var t = this,
          e = t.$createElement,
          s = t._self._c || e;
          return s("section", {
  ...
  237 : function(t, e, s) {
      ...
      var g = function(t, e, s, a) {
          var i, n = arguments.length,
          o = n < 3 ? e: null === a ? a = Object.getOwnPropertyDescriptor(e, s) : a;
          if ("object" === ("undefined" == typeof Reflect ? "undefined": p()(Reflect)) && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, s, a);
          else for (var r = t.length - 1; r >= 0; r--)(i = t[r]) && (o = (n < 3 ? i(o) : n > 3 ? i(e, s, o) : i(e, s)) || o);
          return n > 3 && o && Object.defineProperty(e, s, o),
          o
      },
      ...
      var i = {
          ...
          computed: {
              label() {
                  ...
                  if (0 !== t && !t && !this.suffix) return "盲盒开出";
                  const e = a[String(t)];
                  return e || ""
              }
          }
          ...
          methods: {
              load() {
                  ...
                  var e, s, a; (function() {
                      ...
                      t = e - s > 0 ? e: s,
                      Math.floor(t)
                  })() + Math.floor(document.body.clientHeight) + t >= (s = 0, a = 0, document.body && (s = document.body.scrollHeight), document.documentElement && (a = document.documentElement.scrollHeight), e = s - a > 0 ? s: a, Math.floor(e)) && this.$emit("load")
              }
          }
      },
      o = (s(251), s(10)),
      ...
      var l = {
          ...
          methods: {
              ...
              detail(t) {
                  ...
                  n.c.MergeTargetLocked === e && this.supportMerge && this.isMobile ? this.$router.push(` / zh - cn / item / merge / creating / ?id = $ {
                      s || ""
                  }
                  $ {
                      a ? "&gid=" + a: ""
  ...
  789 : function(t, e, s) {
      ...
      v = (s(668), s(248), {
          ...
          methods: {
              async submit() {
                  ...
                  if (!this.checkSiteFormat()) return void this.toast("社交地址格式不正确", "error");
                  this.loading = !0;
                  const {
                      success: n,
                      message: o
                  } = await a.g.updatePersonalInfo({
                  ...
                  this.loading = !1,
                  n ? (this.$emit("close"), this.$parent.$emit("success")) : this.toast(o, "error")
              },
      ...
      y = {
          ...
          computed: {...Object(o.e)(["uid", "isLogin", "isMobile", "openWalletLoading"]),
              isAccount() {
                  const {
                      uid: t,
                      userId: e
          ...
          methods: {
              ...
              beforeHeadUpload(t) {
                  ...
                  e || (this.toast("上传头像图片大小不能超过 1MB!", "error"), this.uploading = !1),
              ...
              onHeadSuccess({
                  ...
                  this.uploading = !1,
                  t ? (this.user.headImage = e[0], this.saveProfile()) : this.toast(s, "error")
              },
              async saveProfile() {
                  const {
                      headImage: t,
              ...
              async loadUserInfo() {
                  ...
                  const {
                      ...
                      data: e,
                      code: s
                  } = await a.g.getPersonalInfo(this.userId);
      ...
      O = {
          ...
          computed: {...Object(o.e)(["uid", "isMobile"]),
              subTitle() {
                  const {
                      userType: t,
                      totalNum: e
          ...
          methods: {
              ...
              async load() {
                  ...
                  } = this,
                  {
                      success: e,
                      data: s
                  } = await a.o.getGoodsListByAlbumId({...t,
                      uid: this.id
                  });
                  this.loading = !1,
                  this.moreLoading = !1,
                  e ? (this.params.page = s.currPage + 1, this.noMore = 0 === s.hashNext, s && s.list.length && this.list.push(...s.list)) : this.noMore = !0
              },
              status(t) {
                  const {
                      onSale: e,
              ...
              detail(t) {
                  ...
                  x.c.MergeTargetLocked === e && this.supportMerge && this.isMobile ? this.$router.push(` / zh - cn / item / merge / creating / ?id = $ {
                      s || ""
                  }
                  $ {
                      a ? "&gid=" + a: ""
      ...
      A = {
          ...
          methods: {
              ...
              detail(t) {
                  if (t.onSale !== x.c.Resell) if (t.onSale === x.c.Resell || this.isAccount) {
                      if (t.onSale !== x.c.Resell && this.isAccount) {
                          ...
                          let a = e - s;
                          this.$router.push(` / zh - cn / mbox / open / ?id = $ {
                              t.albumId
                          } & num = $ {
                              a
                          } & type = $ {
                  ...
                  } else this.$router.push(` / zh - cn / mbox / item / ?id = $ {
                      t.albumId
                  }`);
                  else this.$router.push(` / zh - cn / mbox / item / ?id = $ {
                      t.albumId
      ...
      D = {
          ...
          computed: {...Object(o.e)(["uid", "isLogin", "isMobile"]),
          ...
          methods: {
              ...
              doSearch() {
                  this.searchParams.keyword ? (this.searchParams.noMore = !1, this.searchParams.list = [], this.searchParams.active = !0, this.searchParams.showMask = !1, this.search()) : this.toast("请输入藏品关键词", "info")
              },
              async search() {
                  if (!this.searchParams.keyword) return;
                  if (this.searchParams.loading) return;
                  ...
                  },
                  {
                      ...
                      data: i,
                      code: n
                  } = await a.o.searchPersonalGoods(e);
                  if (t === this.searchParams.loadId) {
                      if (this.searchParams.doSort = !1, this.searchParams.loading = !1, 102 === n) return this.searchParams.noMore = !0,
                      this.searchParams.list = [],
                      void(this.deny = !0);
                      s ? (this.searchParams.page = i.currPage + 1, this.searchParams.noMore = 0 === i.hashNext, i && i.list.length && this.searchParams.list.push(...i.list)) : this.searchParams.noMore = !0
                  }
              },
              initShare() {
                  const {
              ...
              async load() {
                  ...
                  const {
                      ...
                      data: i,
                      code: n
                  } = await a.o.getCollectionListByUidV3(e);
                  if (t === this.loadId) {
                      if (this.loading = !1, 102 === n) return this.noMore = !0,
                      this.list = [],
                      void(this.deny = !0);
                      s ? (this.page = i.currPage + 1, this.noMore = 0 === i.hashNext, i && i.list.length && this.list.push(...i.list)) : this.noMore = !0
                  }
              },
              change(t) {
                  this.active = t
              ...
              onItemClick(t) {
                  t.onSale !== x.c.Resell ? t.onSale === x.c.Resell || this.isAccount ? t.onSale !== x.c.Resell && this.isAccount && this.$router.push(` / zh - cn / mbox / open / ?id = $ {
                      t.albumId
                  } & num = $ {
                      t.num
                  } & type = $ {
                  ...
                  }`) : this.$router.push(` / zh - cn / mbox / item / ?id = $ {
                      t.albumId
                  }`) : this.$router.push(` / zh - cn / mbox / item / ?id = $ {
                      t.albumId
                  } & gid = $ {
              ...
              syncQuery() {
                  ...
                  history.replaceState(null, document.title, ` / zh - cn / account / ?type = $ {
                      t
                  } & sub = $ {
                      e
                  }
          ...
          watch: {
              active(t) { [0, 2].includes(t) ? this.subActive = 0 : 1 === t && (this.subActive = 1),
                  this.reset(),
                  this.syncQuery(),
                  this.triggerLoad(),
                  this.resetSearch()
              ...
              async account(t) {
                  t ? (this.reset(), this.syncQuery(), await this.triggerLoad()) : this.goHome()
              },
              "user.uid" (t) {
                  this.initShare(),
