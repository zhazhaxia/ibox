          ...
          methods: {
              load() {
                  ...
                  var e, a, s; (function() {
                      ...
                      t = e - a > 0 ? e: a,
                      Math.floor(t)
                  })() + Math.floor(document.body.clientHeight) + t >= (a = 0, s = 0, document.body && (a = document.body.scrollHeight), document.documentElement && (s = document.documentElement.scrollHeight), e = a - s > 0 ? a: s, Math.floor(e)) && this.$emit("load")
              }
          }
      },
      o = (a(251), a(10)),
          ...
          methods: {
              async loadInfo() {
                  const {
                      success: t,
                      data: e
                  } = await s.g.getAlbumDetails(this.brandId);
                  this.brand = e,
                  t && (this.brand = e || {})
              },
              async loadData() {
                  ...
                  } = this,
                  {
                      success: e,
                      data: a
                  } = await s.g.getAlbumByBrand({...this.params,
                      pageSize: t
                  });
                  e ? (this.noMore = !a.hashNext, a.list && a.list.length > 0 && this.list.push(...a.list)) : this.noMore = !0,
                  this.loading = !1
              }
          },
          watch: {
