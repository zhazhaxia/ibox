...
function(e) {
    function c(c) {
        for (var d, b, r = c[0], n = c[1], o = c[2], u = 0, l = []; u < r.length; u++) b = r[u],
    ...
    r.e = function(e) {
        ...
        b[e] ? c.push(b[e]) : 0 !== b[e] && {
            ...
            for (var f = {
                ...
                if (! ("stylesheet" !== l.rel && "preload" !== l.rel || u !== f && u !== t)) return c()
            }
            var i = document.getElementsByTagName("style");
            for (o = 0; o < i.length; o++) {
                var l;
                if ((u = (l = i[o]).getAttribute("data-href")) === f || u === t) return c()
            }
    ...
    r.t = function(e, c) {
        ...
        if (r.r(a), Object.defineProperty(a, "default", {
            enumerable: !0,
            value: e
        }), 2 & c && "string" != typeof e) for (var d in e) r.d(a, d,
        function(c) {
            return e[c]
        }.bind(null, d));
        return a
